function sim_Speaker_FFBSgauss(Tsubsample,Nd,D,Niter,LastIt)
...
BASEDIR1=['PCCdata16kHz_isolated/resultsFFBS_gauss/S' num2str(param.Nd) '_T' num2str(param.T) '_Tsub' num2str(Tsubsample)];
if(~isdir(BASEDIR1))
    mkdir(BASEDIR1);
end
...
param.infer.symbolMethod = 'ffbs_gauss';
