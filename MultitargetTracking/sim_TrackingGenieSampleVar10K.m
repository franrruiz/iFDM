function sim_TrackingGenieSampleVar10K(noiseVar,T,Nd,Niter,LastIt)
% noiseVar=2
% T = 300
% Nd = 3
% Niter = 10K
...
%% Load data
BASEDIR1=['resultsPGAS/GenieSampleVar10K/M' num2str(param.Nd) '_T' num2str(T) '_s2y' num2str(noiseVar)];
load('Final.mat','data');
...
%% Initialization
if(~flagRecovered)
    init.s2y = 100*rand;      % INITIALIZE s2y TO A LARGE VALUE
