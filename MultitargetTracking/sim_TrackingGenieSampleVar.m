function sim_TrackingGenieSampleVar(noiseVar,T,Nd,Niter,LastIt)
% noiseVar=2
% T = 300
% Nd = 3
% Niter = 10K
...
%% Load data
BASEDIR1=['resultsPGAS/GenieSampleVar/M' num2str(param.Nd) '_T' num2str(T) '_s2y' num2str(noiseVar)];
load('Final.mat','data');
